...
public class RequestResource {
	...
	@Path("accepted")
	@GET
	public Response myAcceptedRequest(@PathParam("userId") int userId) throws JsonProcessingException {
		requestService = new RequestService();
		String result = requestService.getAcceptedRequest(userId);
		if(result == "")
	...
	/*
	 * Create a new request in the request table with the request object
	 * recieved Add the request to the corresponding sent user hashtable Add the
	 * request to the corresponding received user hashtable Add to subjects list
